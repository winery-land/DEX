      ...
      <CardBody>
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper text="For each trade a 0.17% fee is paid. 0.12% goes to liquidity providers and 0.05% goes to the WinerySwap treasury." />
          </RowFixed>
          <Text fontSize="14px">
