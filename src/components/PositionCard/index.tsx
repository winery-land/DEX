...
import { Card as UIKitCard, CardBody, GradientButton, Text } from '@apeswapfinance/uikit'
        ...
        {showMore && (
          <AutoColumn gap="8px">
            ...
            <RowBetween marginTop="10px">
              <GradientButton as={Link} to={`/trade/add/${currencyId(currency0)}/${currencyId(currency1)}`} style={{ width: '48%' }}>
                Add
              </GradientButton>
              <GradientButton
                as={Link}
