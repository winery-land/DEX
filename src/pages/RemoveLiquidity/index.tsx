...
import { ButtonMenuItem, Flex, GradientButton, Text } from '@apeswapfinance/uikit'
  ...
  function modalBottom() {
    return (
      <>
        ...
        <GradientButton disabled={!(approval === ApprovalState.APPROVED || signatureData !== null)} onClick={onRemove}>
          Confirm
        </GradientButton>
      </>
    )
                  ...
                  {!showDetailed && (
                    <>
                      ...
                      <Flex justifyContent="space-around">
                        <ButtonMenuItem isActive={innerLiquidityPercentage === 25} variant="gradient" size="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '25')}>
                          25%
                        </ButtonMenuItem>
                        <ButtonMenuItem isActive={innerLiquidityPercentage === 50} variant="gradient" size="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '50')}>
                          50%
                        </ButtonMenuItem>
                        <ButtonMenuItem isActive={innerLiquidityPercentage === 75} variant="gradient" size="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '75')}>
                          75%
                        </ButtonMenuItem>
                        <ButtonMenuItem
