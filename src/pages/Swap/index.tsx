...
import { CardBody, ArrowDownIcon, IconButton, Text, GradientButton } from '@apeswapfinance/uikit'
          ...
          <CardBody>
            ...
            <BottomGrouping>
              {!account || chainId !== mainChainId ? (
                ...
                <GradientButton disabled={Boolean(wrapInputError)} onClick={onWrap} fullWidth>
                  {wrapInputError ??
